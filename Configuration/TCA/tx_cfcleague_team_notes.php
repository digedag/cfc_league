...
$tx_cfcleague_team_notes = [
    'ctrl' => [
        'title' => 'LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_team_notes',
        'label' => 'uid',
    ...
    'columns' => [
        ...
        'team' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_teams',
            'config' => [
                'type' => 'select',
        ...
        'type' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_note_types',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'mediatype' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_team_notes.mediatype',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
                    ['LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_team_notes.mediatype.text', '0'],
                    ['LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_team_notes.mediatype.number', '2'],
                ],
                'size' => 1,
                'maxitems' => 1,
            ],
        ...
        'player' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_profiles',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
        ...
        'number' => [
            'exclude' => 1,
            'label' => 'LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_team_notes.number',
            'config' => [
                'type' => 'input',
                'size' => '4',
                'max' => '4',
...
$tx_cfcleague_team_notes['columns']['media']['label'] = 'LLL:EXT:cfc_league/Resources/Private/Language/locallang_db.xlf:tx_cfcleague_team_notes.media';
