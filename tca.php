...
*/
	...
	'types' => Array (
		'0' => Array('showitem' => 'hidden;;1;;1-1-1, name, internal_name, short_name, agegroup, saison, type;;2, point_system, logo, teams, match_keys, table_marks, match_parts')
	),
	'palettes' => Array (
		'1' => Array('showitem' => ''),
...
$TCA['tx_cfcleague_club'] = Array (
	...
	'types' => Array (
		'0' => Array('showitem' => 'hidden;;1;;1-1-1, name,short_name,dam_logo,favorite,stadiums,
...
$TCA['tx_cfcleague_stadiums'] = Array (
	...
	'columns' => Array (
		...
		'logo' => txdam_getMediaTCA('image_field', 'logo'),
		'pictures' => txdam_getMediaTCA('image_field', 'pictures'),
		'clubs' => Array (
			'exclude' => 1,
