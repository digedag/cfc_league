...
$LOCAL_LANG = Array(
  'default' => Array(
    '.description' => '
      A competition collects a number of matches. You can define a competition as 
      league, cup or friendly matches. Most details are used for leagues only. ',
    'match_keys.description' => 'See details for some example keysets used in Germany.',
    'match_keys.details' => '
<h2>Some match keysets used in Germany</h2>
<pre>
8 Teams:
--------
...
1-17,3-14,5-12,7-10,9-8,11-6,13-4,15-2,18-16|2-13,4-11,6-9,8-7,10-5,12-3,14-18,16-1,17-15|1-15,3-10,5-8,7-6,9-4,11-2,13-17,16-14,18-12|2-9,4-7,6-5,8-3,10-18,12-16,14-1,15-13,17-11|1-13,3-6,5-4,7-2,9-17,11-15,14-12,16-10,18-8|2-5,4-3,6-18,8-16,10-14,12-1,13-11,15-9,17-7|1-11,3-2,5-17,7-15,9-13,12-10,14-8,16-6,18-4|2-18,4-16,6-14,8-12,10-1,11-9,13-7,15-5,17-3|1-9,3-15,5-13,7-11,10-8,12-6,14-4,16-2,18-17|2-14,4-12,6-10,8-1,9-7,11-5,13-3,15-18,17-16|1-7,3-11,5-9,8-6,10-4,12-2,14-17,16-15,18-13|2-10,4-8,6-1,7-5,9-3,11-18,13-16,15-14,17-12|1-5,3-7,6-4,8-2,10-17,12-15,14-13,16-11,18-9|2-6,4-1,5-3,7-18,9-16,11-14,13-12,15-10,17-8|1-3,4-2,6-17,8-15,10-13,12-11,14-9,16-7,18-5|1-2,3-18,5-16,7-14,9-12,11-10,13-8,15-6,17-4|2-17,4-15,6-13,8-11,10-9,12-7,14-5,16-3,18-1
    ...
    'teams.details' => '
      ...
      <p>If you want to create a matchplan by keystring, ensure the right order of teams starting 
      by team number 1.</p>
      </p>',
    'internal_name.description' => 'This name is shown in backend only.',
    'table_marks.description' => 'Mark positions in league tables.',
    'table_marks.details' => '
This is a simple way to include specific CSS-Markers in league tables.
      
<b>Format:</b>
position[,position];marker,description[|position;marker,description]

<b>Example:</b>
1;green,Champion|14,15,16;red,Relegation

The example marks position <b>1</b> with marker <b style="color:green">green</b> and positions <b>14 to 16</b> with marker <b style="color:red">red</b>. The description is optional.
In your FE HTML-Template is a marker ###ROW_MARK###. Each time a defined position is rendered, this marker will be filled with the string you defined. The description is accessible by marker ###ROW_MARKLABEL###.
The default template uses this marker to create a predefined CSS-Class. Have a look at the template <b>leaguetable.html</b> in <b>cfc_league_fe</b> to understand the principle. 
    ',
  ),
