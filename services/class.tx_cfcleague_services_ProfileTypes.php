...
class tx_cfcleague_services_ProfileTypes extends t3lib_svbase {
	...
	function setProfileTypeItems(&$uids) {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cfc_league/services/class.tx_cfcleague_services_ProfileTypes.php']) {
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cfc_league/services/class.tx_cfcleague_services_ProfileTypes.php']);
}
