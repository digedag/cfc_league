...
if (TYPO3_MODE == 'BE') {
    ...
    if (tx_rnbase_util_TYPO3::isTYPO60OrHigher()) {
        ...
        tx_rnbase_util_Extensions::registerModule('cfc_league', 'web', 'M1', 'bottom', array(), array(
            'access' => 'user,group',
        ...
        tx_rnbase_util_Extensions::addModule('web', 'txcfcleagueM1', '', tx_rnbase_util_Extensions::extPath($_EXTKEY) . 'mod1/', array(
            'labels' => array(
                'tabs_images' => array(
