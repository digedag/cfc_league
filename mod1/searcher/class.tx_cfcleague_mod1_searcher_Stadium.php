...
class tx_cfcleague_mod1_searcher_Stadium {
	...
	private function showStadiums(&$content, $items) {
		...
		$columns = array(
			...
			'name' => array('title' => 'label_name'),
			'capacity' => array('title' => 'label_capacity'),
			'address' => array('title' => 'label_address', 'decorator' => $decor),
			'longlat' => array('title' => 'label_longlat', 'decorator' => $decor),
		);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cfc_league/mod1/searcher/class.tx_cfcleague_mod1_searcher_Stadium.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cfc_league/mod1/searcher/class.tx_cfcleague_mod1_searcher_Stadium.php']);
}
?>